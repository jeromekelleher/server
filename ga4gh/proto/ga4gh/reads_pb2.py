...
# source: ga4gh/proto/ga4gh/reads.proto
...
_READGROUPSET_INFOENTRY = _descriptor.Descriptor(
  name='InfoEntry',
  full_name='ga4gh.ReadGroupSet.InfoEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ga4gh.ReadGroupSet.InfoEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='ga4gh.ReadGroupSet.InfoEntry.value', index=1,
...
_READGROUPSET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reference_set_id', full_name='ga4gh.ReadGroupSet.reference_set_id', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='ga4gh.ReadGroupSet.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.ReadGroupSet.info', index=5,
...
_READGROUP_EXPERIMENT = _descriptor.Descriptor(
  name='Experiment',
  full_name='ga4gh.ReadGroup.Experiment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='library_id', full_name='ga4gh.ReadGroup.Experiment.library_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='platform_unit', full_name='ga4gh.ReadGroup.Experiment.platform_unit', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sequencing_center', full_name='ga4gh.ReadGroup.Experiment.sequencing_center', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='instrument_model', full_name='ga4gh.ReadGroup.Experiment.instrument_model', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READGROUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='programs', full_name='ga4gh.ReadGroup.programs', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reference_set_id', full_name='ga4gh.ReadGroup.reference_set_id', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.ReadGroup.info', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='created', full_name='ga4gh.ReadGroup.created', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='updated', full_name='ga4gh.ReadGroup.updated', index=11,
...
_READ_INFOENTRY = _descriptor.Descriptor(
  name='InfoEntry',
  full_name='ga4gh.Read.InfoEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ga4gh.Read.InfoEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='ga4gh.Read.InfoEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READ = _descriptor.Descriptor(
  name='Read',
  full_name='ga4gh.Read',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='ga4gh.Read.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='read_group_id', full_name='ga4gh.Read.read_group_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='fragment_name', full_name='ga4gh.Read.fragment_name', index=2,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='proper_placement', full_name='ga4gh.Read.proper_placement', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='duplicate_fragment', full_name='ga4gh.Read.duplicate_fragment', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fragment_length', full_name='ga4gh.Read.fragment_length', index=5,
      number=7, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='read_number', full_name='ga4gh.Read.read_number', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='number_reads', full_name='ga4gh.Read.number_reads', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='failed_vendor_quality_checks', full_name='ga4gh.Read.failed_vendor_quality_checks', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alignment', full_name='ga4gh.Read.alignment', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='secondary_alignment', full_name='ga4gh.Read.secondary_alignment', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='supplementary_alignment', full_name='ga4gh.Read.supplementary_alignment', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='aligned_sequence', full_name='ga4gh.Read.aligned_sequence', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='aligned_quality', full_name='ga4gh.Read.aligned_quality', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='next_mate_position', full_name='ga4gh.Read.next_mate_position', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='info', full_name='ga4gh.Read.info', index=15,
...
_SEARCHREADGROUPSETSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='dataset_ids', full_name='ga4gh.SearchReadGroupSetsRequest.dataset_ids', index=0,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='ga4gh.SearchReadGroupSetsRequest.page_token', index=2,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHREADSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reference_name', full_name='ga4gh.SearchReadsRequest.reference_name', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='ga4gh.SearchReadsRequest.page_token', index=4,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='ga4gh.SearchReadsRequest.page_size', index=5,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READGROUPSET_INFOENTRY.fields_by_name['value'].message_type = ga4gh_dot_proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
...
_READGROUP_INFOENTRY.fields_by_name['value'].message_type = ga4gh_dot_proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
...
_LINEARALIGNMENT.fields_by_name['position'].message_type = ga4gh_dot_proto_dot_ga4gh_dot_common__pb2._POSITION
_LINEARALIGNMENT.fields_by_name['cigar'].message_type = ga4gh_dot_proto_dot_ga4gh_dot_common__pb2._CIGARUNIT
_READ_INFOENTRY.fields_by_name['value'].message_type = ga4gh_dot_proto_dot_google_dot_protobuf_dot_struct__pb2._LISTVALUE
_READ_INFOENTRY.containing_type = _READ
_READ.fields_by_name['alignment'].message_type = _LINEARALIGNMENT
_READ.fields_by_name['next_mate_position'].message_type = ga4gh_dot_proto_dot_ga4gh_dot_common__pb2._POSITION
_READ.fields_by_name['info'].message_type = _READ_INFOENTRY
_SEARCHREADGROUPSETSRESPONSE.fields_by_name['read_group_sets'].message_type = _READGROUPSET
_SEARCHREADSRESPONSE.fields_by_name['alignments'].message_type = _READ
...
ReadGroupSet = _reflection.GeneratedProtocolMessageType('ReadGroupSet', (_message.Message,), dict(
  ...
  InfoEntry = _reflection.GeneratedProtocolMessageType('InfoEntry', (_message.Message,), dict(
    ...
    __module__ = 'ga4gh.proto.ga4gh.reads_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.ReadGroupSet.InfoEntry)
    ))
  ,
...
ReadGroup = _reflection.GeneratedProtocolMessageType('ReadGroup', (_message.Message,), dict(
  ...
  Experiment = _reflection.GeneratedProtocolMessageType('Experiment', (_message.Message,), dict(
    ...
    __module__ = 'ga4gh.proto.ga4gh.reads_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.ReadGroup.Experiment)
    ))
  ,
...
Read = _reflection.GeneratedProtocolMessageType('Read', (_message.Message,), dict(
  ...
  InfoEntry = _reflection.GeneratedProtocolMessageType('InfoEntry', (_message.Message,), dict(
    ...
    __module__ = 'ga4gh.proto.ga4gh.reads_pb2'
    # @@protoc_insertion_point(class_scope:ga4gh.Read.InfoEntry)
    ))
  ,
  DESCRIPTOR = _READ,
  __module__ = 'ga4gh.proto.ga4gh.reads_pb2'
  # @@protoc_insertion_point(class_scope:ga4gh.Read)
  ))
